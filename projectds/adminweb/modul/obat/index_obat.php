...
<script type="text/javascript" src="modul/obat/obat.js"></script>
...
<div class="col-md-12" style="padding-bottom: 0px;padding-top: 25px;padding-right: 25px;padding-left: 15px;height: 182.688px;width: 100%;">
  ...
  <div class="page-header" style="margin-top: 10px;">
    <h1 style="font-size: 23px;margin-top: 8px;height: 30.6875px;">
      <i class="glyphicon glyphicon-lock" style="font-size: 18px;"></i>&nbsp;Data obat
    </h1>
  </div>
  <div class="row">
    <div class='col-md-6 text-left'>
      <div class="btn-group" role="group" aria-label="Toolbar">
        <button id='lihat_data_obat' class='btn btn-info' data-toggle='tooltip' data-placement='top' title='Lihat Data obat' style='color:white;'>
          <i class='far fa-eye' style='font-size: 15px;'></i> Lihat </button><button id='tambah_data_obat' class='btn btn-success' data-toggle='tooltip' data-placement='top' title='Edit Data'>
          <i class='far fa-plus-square' style='font-size: 15px;'></i> Tambah
        </button>
        <button id='edit_data_obat' class='btn btn-primary' data-toggle='tooltip' data-placement='top' title='Edit Data'>
          <i class='far fa-edit' style='font-size: 15px;'></i> Edit
        </button>
        <button id='hapus_data_obat' class='btn btn-danger' data-toggle='tooltip' data-placement='top' title='Hapus Data'>
    ...
    <div class='col-md-6 text-right'>
      <div class='input-group'>
        ...
        <div class='input-group-prepend'>
          <select id='search_field_obat' name='search_field_obat'> <option value='id_obat'>id_obat</option>
<option value='nama'>nama</option>
<option value='deskripsi'>deskripsi</option>
 </select>
        </div>
        <span id='searchclear_obat' data-toggle='tooltip' data-placement='top' title='Clear'><i class="fas fa-times"></i></span>
        <input class='form-control' name='search_text_obat' id='search_text_obat' type='search' placeholder='Masukkan Kata Kunci Pencarian' />
      </div>
    </div>
  </div>
</div>
<!-- Modal -->
<div id="modal_obat" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 id="modal-title" class="modal-title">Edit Data obat</h4>
...
<label>deskripsi<br /></label><input type='text' class='form-control' id='deskripsi' name='deskripsi' /><div><span class='error'></span></div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="simpan_data_obat" class="btn btn-primary">Simpan Data</button>
        </form>
      </div>
    </div>
  </div>
</div>
<div id="modal_lihat_obat" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 id="modal-title" class="modal-title">Lihat Data obat</h4>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body">
        <div id="forTable_obat"></div>
      </div>
      <div class="modal-footer">
        <button class="btn btn-default" type="button" data-dismiss="modal">Close</button>
...
<div style="width:100%">
  <table id="tbl_obat" class="display dataTable" style="width:100%">
    <thead>
      <tr> <th>id_obat</th>
<th>nama</th>
<th>deskripsi</th>
